...
[ $# -eq 8 ] || die "expecting exactly 4 arguments after options"
tax1=$1; tax2=$2
GO1=$3; GO2=$4; 
G2=$5; tax3=$6;
tax4=$7; tax5=$8
...
grep "^$tax3	" $GO1.$GENE2GO | cut -f1-5,8 >> $TMPDIR/GO1.tax1.$GENE2GO.1-5,8
grep "^$tax4	" $GO1.$GENE2GO | cut -f1-5,8 >> $TMPDIR/GO1.tax1.$GENE2GO.1-5,8
grep "^$tax5	" $GO1.$GENE2GO | cut -f1-5,8 >> $TMPDIR/GO1.tax1.$GENE2GO.1-5,8
